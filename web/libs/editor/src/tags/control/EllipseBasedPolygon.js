...
const Model = types
  .model({
    type: "ellipsebasedpolygon",

    // regions: types.array(RectRegionModel),
    _value: types.optional(types.string, ""),
  })
  .volatile(() => ({
    toolNames: ["EllipseBasedPolygon"],
  }))
  .actions((self) => {
    return {
      initializeHotkeys() {
...
const EllipseBasedPolygonModel = types.compose(
...
Registry.addTag("ellipsebasedpolygon", EllipseBasedPolygonModel, HtxView);

export { HtxView, EllipseBasedPolygonModel };
